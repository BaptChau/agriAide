...
class Post
{
    ...
    public function getCorpse(): ?string
    {
        return $this->corpse;
    }

    public function setCorpse(string $corpse): self
    {
        $this->corpse = $corpse;
    ...
    public function setCategoryId(?PostCategory $categoryId): self
    {
    ...
    public function getSubCategoryId(): ?PostSubCategory
    {
